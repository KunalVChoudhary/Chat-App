...
function RightSideBar() {
  ...
  return selectedUser && (
    <div className={`bg-[#8185B2]/10 text-white w-fill relative overflow-y-scoll ${selectedUser && 'max-md:hidden'}`}>
      <div className='pt-16 flex flex-col items-center gap-2 text-xs font-light mx-auto'>
        <img src={selectedUser?.profilePic || assets.avatar_icon} alt="avatar icon" className='w-20 aspect-[1/1] rounded-full' />
